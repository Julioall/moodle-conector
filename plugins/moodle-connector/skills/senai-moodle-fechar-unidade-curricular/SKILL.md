...
1. Resolva conexão, curso, UC, período e atividades com 'moodle-localizar-contexto-curso'.
2. Execute 'moodle-auditar-notas' para cada atividade avaliativa e registre o denominador.
