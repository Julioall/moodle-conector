---
name: moodle-organizar-recuperacao
...
1. Resolva conexão, curso, UC e atividades com 'moodle-localizar-contexto-curso'.
2. Audite notas e entregas com 'moodle-auditar-notas'.
...
5. Encaminhe a criação para 'senai-criar-recuperacao-original'.
6. Se houver questionário, encaminhe para 'senai-gerar-questionario-moodle-gift' e faça a correspondência entre capacidades, itens e critérios.
...
8. Só encaminhe para 'moodle-publicar-questionario' ou outro fluxo de escrita depois que o usuário selecionar explicitamente o que será publicado e confirmar a prévia.
