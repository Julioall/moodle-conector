...
| O arquivo foi lido integralmente? | `prepare_submission_grading` e `resource/file` | O resource original é a única fonte; falha de registro, leitura, autorização, integridade ou limite exige revisão manual. |
