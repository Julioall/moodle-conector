---
name: moodle-questionnaire-publishing
...
# moodle-questionnaire-publishing

Use quando o usuário pedir para importar, criar ou publicar um questionário no Moodle. A geração do conteúdo pertence a 'moodle-questionnaire-gift'; esta skill cuida da fronteira operacional.

## Fluxo obrigatório

1. Resolva conexão, curso, seção, categoria e identificadores com 'moodle-course-context'.
