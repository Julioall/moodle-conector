...
export type Followup = { id: string; studentRef: string; courseRef?: string; kind: string; reason?: string; action?: string; status?: string; notes: string; occurredAt: string; createdAt: string };
export type FollowupInput = { studentRef: string; courseRef?: string; kind: string; reason?: string; action?: string; status?: string; notes: string; occurredAt?: string };
