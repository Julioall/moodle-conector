...
export function CoursePanelPage() {
  ...
  const activeTab = requestedTab === 'students' ? 'students' : 'corrections';
  ...
  const setTab = (tab: string) => {
    setSearchParams((current) => {
      ...
      if (tab === 'corrections') next.delete('tab');
  ...
  const refreshCourseData = async () => {
    ...
    try {
      ...
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: ['app', 'corrections', 'activities', connectionRef, courseId] }),
        queryClient.invalidateQueries({ queryKey: ['app', 'corrections', 'students', connectionRef, courseId] }),
        queryClient.invalidateQueries({ queryKey: ['app', 'submissions', connectionRef, courseId] }),
