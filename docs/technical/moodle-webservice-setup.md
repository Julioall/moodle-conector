...
> **Nota:** A função `mod_forum_get_forum_discussions_paginated` foi deprecada e removida no Moodle 5.0. O conector usa a versão correta `mod_forum_get_forum_discussions`.
